    ...
    <div class="my-2">
      ...
      <label>
        <textarea name="bio" class="input <?php echo ($errors['bio'] != NULL) ? 'red' : ''; ?>"
          placeholder="Биография"><?= h($values['bio']) ?></textarea>
